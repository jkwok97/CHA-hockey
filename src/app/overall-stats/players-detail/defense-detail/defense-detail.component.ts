...
@Component({
  ...
  styleUrls: ['./defense-detail.component.css']
})
export class DefenseDetailComponent implements OnInit, OnDestroy {
  ...
  getStats(season: string, seasonType: string) {
    this._playerStatsService.getPlayersBySeasonByDefense(season, seasonType).pipe(
