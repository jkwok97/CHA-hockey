...
export class NewPlayoffTreeComponent implements OnInit, OnDestroy {
  ...
  setQuarterMatchups(teams: any[], type: string) {
    if (type === 'west') {
      this.westernQuarterMatchups.push({homeTeam: teams.find(team => team.seed === 1), visitingTeam: teams.find(team => team.seed === 8), series: "4 - 1"});
      this.westernQuarterMatchups.push({homeTeam: teams.find(team => team.seed === 4), visitingTeam: teams.find(team => team.seed === 5), series: "4 - 3"});
      this.westernQuarterMatchups.push({homeTeam: teams.find(team => team.seed === 3), visitingTeam: teams.find(team => team.seed === 6), series: "3 - 4"});
      ...
      this.easternQuarterMatchups.push({homeTeam: teams.find(team => team.seed === 4), visitingTeam: teams.find(team => team.seed === 5), series: "4 - 1"});
      this.easternQuarterMatchups.push({homeTeam: teams.find(team => team.seed === 3), visitingTeam: teams.find(team => team.seed === 6), series: "4 - 1"});
      this.easternQuarterMatchups.push({homeTeam: teams.find(team => team.seed === 2), visitingTeam: teams.find(team => team.seed === 7), series: "4 - 3"});
    }
  }
