...
export class PlayerInformationRatingsComponent implements OnInit, OnDestroy {
  ...
  goalieRateColumns = ["passing", "skating", "speed"];
  ...
  constructor(
    ...
    this.playerType === "player"
      ? this.getPlayerRatings(playerId, "2022-23")
      : this.getGoalieRatings(playerId, "2022-23");
  }
